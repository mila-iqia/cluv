...
def build_sbatch_command(
    ...
    return get_sbatch_command(
        ...
        env_vars=get_job_env_vars(cluster, git_commit, cluster_config, extra_env=extra_env),
    )
...
class TestGetSbatchCommand:
    ...
    def test_in_job_packing_uses_job_and_task_placeholders_in_output_path(
        ...
        assert f"--output={results_path}/mila_%j_%t/slurm-%j_%t.out" in sbatch_command
